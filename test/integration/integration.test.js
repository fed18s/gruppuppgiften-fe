...
describe('integration tests for listenToRadioButton', () => {
    let fetchBackup, listenToRadioButton;

    beforeAll(() => {
        document.body.innerHTML = `
    <form action="">
      <input checked="checked" type="radio" name="animal" value="cat">Cats
      <input type="radio" name="animal" value="pokemon" id="pokemon">Pokémons
      ...
      <select id="animal-select"><option value="-1">TEST</option></select>`;
        ...
        listenToRadioButton = require('../../src/js/animalApp').listenToRadioButton;        
    });
